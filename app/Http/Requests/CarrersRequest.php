...
class CarrersRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        $rules = [
            ...
            'meta_title.zh' => ['nullable', 'string'],
            'meta_title.zh-Hant' => ['nullable', 'string'],
            'meta_description' => ['nullable', 'array'],
            'meta_description.en' => ['nullable', 'string'],
            'meta_description.zh' => ['nullable', 'string'],
            'meta_description.zh-Hant' => ['nullable', 'string'],
            'status' => ['required', new Enum(CarrersStatus::class)],
        ];
        ...
        if ($this->method() == 'PUT') {
            ...
            $rules['meta_title.en'] = ['nullable', 'string'];
            $rules['meta_title.zh'] = ['nullable', 'string'];
            $rules['meta_title.zh-Hant'] = ['nullable', 'string'];
            $rules['meta_description'] = ['nullable', 'array'];
            $rules['meta_description.en'] = ['nullable', 'string'];
            $rules['meta_description.zh'] = ['nullable', 'string'];
            $rules['meta_description.zh-Hant'] = ['nullable', 'string'];
            $rules['image'] = ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,svg'];
            $rules['status'] = ['sometimes', new Enum(CarrersStatus::class)];
        }

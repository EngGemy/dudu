 ...
 */
class EventIteration extends Model
{
    use Translatable;
     ...
     * @var array
     */
    protected $table = 'event_iterations';
    ...
    {
        return ($value !== null) ? asset('assets/images/event_iteration/'.$value) : '';
    }
    ...
    public function event_iteration_attributes()
    {
        return $this->hasMany(EventIterationAttribute::class, 'event_iteration_id');
    }

    public function event_iterations_translations()
    {
        return $this->hasMany(EventIterationTranslation::class, 'event_iteration_id');
    }

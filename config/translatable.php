...
return [
    ...
    */
    ...
    |
    | For this app the chain is:
    |   zh-Hant  →  zh  →  en
    | This works because the package detects country-based locales and
    | extracts the base language (e.g. "zh" from "zh-Hant") before
    | falling back to the configured fallback_locale ("en").
    |
    */
    'fallback_locale' => 'en',

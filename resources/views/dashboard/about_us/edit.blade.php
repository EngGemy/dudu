...
{{--                                                                    <option value="0" @if($about_us->status == 0) selected @endif>Header</option>--}}
                                                                    <option value="1" @if($about_us->status == 1) selected @endif>Who We Are</option>
                                                                    <option value="2" @if($about_us->status == 2) selected @endif>Mission</option>
                                                                    <option value="3" @if($about_us->status == 3) selected @endif>Vision</option>
                                                                    <option value="4" @if($about_us->status == 4) selected @endif>Services</option>
                                                                    <option value="5" @if($about_us->status == 5) selected @endif>Team</option>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                @include('dashboard._partials.locale-tabs', [
                                                                    ...
                                                                    'maxlength' => 255,
                                                                    'required' => true,
                                                                    'translations' => $about_us->translations,
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-3">
                                                                <img src="{{$about_us->image_url}}" style="width: 100px; height: 100px;object-fit: contain">
                                                            </div>
                                                        </div>
                                                    </div>

            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Gallary</h2>
                            <div class="btn-back">
                                <a style="float: left" href="{{route('blogs.index')}}" class="btn btn-primary  "><i class="fa fa-reply" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-horizontal"
                                              action="{{route('gallary_blog.update')}}"
                                              method="POST"
                                                                ...
                                                                <div class="row" >
                                                                    @foreach($galleries as $image)
                                                                        ...
                                                                        <div class="col-md-2" style="text-align: center">
                                                                            <img style="object-fit: contain;height:130px; width:130px;" src="{{$image->image_url}}"><br>
                                                                            <a  href="{{route('gallary_blog.destroy',$image->id)}}" class="btn btn-danger"  onclick="return confirm('do you want to delete this photo?');"> <i class="fas fa-trash"></i>
...
@section('scripts')
    ...
    <script>
        ...
        Dropzone.options.dpzMultipleFiles= {
            ...
            url: "{{route('gallary_blog.storegallary')}}",

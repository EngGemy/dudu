                                                ...
                                                @foreach($bookings as $booking)
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            ...
                                                            <a class="btn btn-primary btn-icon btn-circle btn-sm" href="{{route('booking.delete',$booking->id)}}" onclick="return confirm('Are you sure you want to delete?');" title="Delete">

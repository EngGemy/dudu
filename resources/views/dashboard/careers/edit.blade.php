                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <select class="form-control" name="status">
                                                                    ...
                                                                    <option value="0" @if($career->status == 0) selected @endif>Header</option>
                                                                    <option value="1" @if($career->status == 1) selected @endif>Body</option>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-3">
                                                                <img src="{{$career->image_url}}" style="width: 100px; height: 100px;object-fit: contain">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-3">
                                                                <img src="{{$career->meta_img}}" style="width: 100px; height: 100px;object-fit: contain">
                                                            </div>

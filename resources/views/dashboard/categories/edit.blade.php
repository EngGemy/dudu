                                                                ...
                                                                <select class="form-control" name="parent_id" >
                                                                    ...
                                                                    @if($categories && $categories -> count() > 0)
                                                                        @foreach($categories as $cat)
                                                                            <option
                                                                                value="{{$cat -> id }}" @if($category->parent_id == $cat->id) selected @endif>{{$cat -> translate(app()->getLocale(), true)->name ?? ''}}</option>
                                                                        @endforeach
                                                                    @endif
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <div class="custom-control custom-switch custom-switch-success mr-2 mb-1">
                                                                    ...
                                                                    <input type="checkbox" @if($category->is_active ==1) checked @endif class="custom-control-input" id="customSwitch4" name="is_active">

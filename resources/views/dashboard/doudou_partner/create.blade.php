            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Dodue Partner</h2>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        action="{{route('doudou_partner.update')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-body ">
                                            <div class="row">
                                                <div class="col-12">
                                                            ...
                                                            <div class="row" >
                                                                @foreach($galleries as $image)
                                                                    ...
                                                                    <div class="col-md-2" style="text-align: center">
                                                                        ...
                                                                        <a  href="{{route('doudou_partner.destroy',$image->id)}}" class="btn btn-danger"  onclick="return confirm('do you want to delete this photo?');"> <i class="fas fa-trash"></i>
...
@section('scripts')
    ...
    <script>
        ...
        Dropzone.options.dpzMultipleFiles= {
            ...
            url: "{{route('doudou_partner.storegallary')}}",

                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="btn-back">
                                <a style="float: left" href="{{route('events.index')}}" class="btn btn-primary  "><i class="fa fa-reply" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-horizontal"
                                              action="{{route('events.gallary.update')}}"
                                              method="POST"
                                                                ...
                                                                <div class="row" >
                                                                    @foreach($galleries as $image)
                                                                        ...
                                                                        <div class="col-md-2" style="text-align: center">
                                                                            ...
                                                                            <a  href="{{route('events.gallary.destroy',$image->id)}}" class="btn btn-danger"  onclick="return confirm('do you want to delete this photo?');"> <i class="fas fa-trash"></i>
...
@section('scripts')
    ...
    <script>
        ...
        Dropzone.options.dpzMultipleFiles= {
            ...
            url: "{{route('events.gallary.storegallary')}}",

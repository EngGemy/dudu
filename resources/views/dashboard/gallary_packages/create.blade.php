            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Gallary Packages</h2>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        action="{{route('gallary_packages.update')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-body ">
                                            <div class="row">
                                                <div class="col-12">
                                                            ...
                                                            <div class="row" >
                                                                @foreach($galleries as $image)
                                                                    ...
                                                                    <div class="col-md-2" style="text-align: center">
                                                                        ...
                                                                        <a  href="{{route('gallary_packages.destroy',$image->id)}}" class="btn btn-danger"  onclick="return confirm('do you want to delete this photo?');"> <i class="fas fa-trash"></i>
...
@section('scripts')
    ...
    <script>
        ...
        Dropzone.options.dpzMultipleFiles= {
            ...
            url: "{{route('gallary_packages.storegallary')}}",

            ...
            <div class="navbar-collapse" id="navbar-mobile">
                <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                    ...
                    <ul class="nav navbar-nav bookmark-icons">
                        ...
                        <a  class="btn btn-secondary " href="{{route('home')}}" target="_blank" role="button" aria-haspopup="true" aria-expanded="false">
                            Visit Website
                        </a>
                    </ul>
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-globe"></i></a>
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            <li class="scrollable-container media-list">
                                ...
                                <a class="d-flex justify-content-between"
                                   @if($notification->data['type']=='message') href="{{route('message.index',$notification->id)}}"
                                   @elseif($notification->data['type']=='booking') href="{{route('booking.index',$notification->id)}}"
                                   @elseif($notification->data['type']=='join') href="{{route('join_teams.index',$notification->id)}}"
                            ...
                            <li class="dropdown-menu-footer"><a class="dropdown-item p-1 text-center" href="{{route('MarkAsRead_all')}}">Read all notifications</a></li>
                        </ul>
                    </li>
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">{{\Illuminate\Support\Facades\Auth::user()->username}}</span><span class="user-status">Active</span></div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{route('edit.profile')}}" style="font-size: 10px"> <i class="feather icon-user"></i>Profile</a>
                            <div class="dropdown-divider"></div><a class="dropdown-item" href="{{route('admin.logout')}}" style="font-size: 11px"><i class="feather icon-power"></i>Logout</a>
                        </div>
                    </li>
                </ul>
            </div>

                                        ...
                                        <div class="table-responsive">
                                            <table class="table zero-configuration">
                                                ...
                                                @foreach($messages as $message)
                                                    <tr>
                                                        <td>{{ $i }}</td>
                                                        <td>{{$message->getTitle($message->title)  }}</td>
                                                        <td>{{ $message->name }}</td>
                                                        <td>{{ $message->email  }}</td>
                                                        ...
                                                        <td class="text-right">
                                                            ...
                                                            <a class="btn btn-primary btn-icon btn-circle btn-sm" href="{{route('message.delete',$message->id)}}" onclick="return confirm('Are you sure you want to delete?');" title="Delete">

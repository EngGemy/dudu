                                                                ...
                                                                <div class="table-responsive users-view-permission">
                                                                    <table class="table table-borderless">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="custom-control custom-checkbox ml-30"><input type="checkbox" id="users-checkbox{{$i}}{{$j}}" class="custom-control-input" name="permissions[]" value="{{ $name }}" {{ in_array($name, $role->permissions)? 'checked' : '' }}>  <label class="custom-control-label" for="users-checkbox{{$i}}{{$j}}">{{$value }}</label>
                                                                                </div>
                                                                            </td>
                                                                                    <?php $i++ ?>
                                                                                @endforeach

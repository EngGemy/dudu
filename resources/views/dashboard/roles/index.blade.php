            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                    <div class="form-group breadcrum-right">
                        <div class="dropdown">
                            <a href="{{route('roles.create')}}" class="btn btn-primary mb-2 waves-effect waves-light"><i class="feather icon-plus"></i>&nbsp; Add</a>
                                            ...
                                            <table class="table zero-configuration">
                                                ...
                                                @foreach($roles as $role)
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <a class="btn btn-primary btn-icon btn-circle btn-sm" href="{{route('roles.edit',$role->id)}}" title="Edit">

            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                    <div class="form-group breadcrum-right">
                        <div class="dropdown">
                            <a href="{{ route('tips.create') }}" class="btn btn-primary mb-2 waves-effect waves-light">
                                            ...
                                            <table class="table zero-configuration">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($tips as $tip)
                                                        <tr>
                                                            <td>{{ $i }}</td>
                                                            <td>{{ $tip->translate(app()->getLocale(), true)->name ?? '—' }}</td>
                                                            <td>
                                                            ...
                                                            <td><img style="width: 75px; height: 75px;" src="{{ $tip->image_url }}"></td>
                                                            <td class="text-right">
                                                                <a class="btn btn-primary btn-icon btn-circle btn-sm"
                                                                   href="{{ route('tips.edit', $tip->id) }}" title="Edit">
                                                                    <i class="fas fa-edit"></i>
                                                                </a>
                                                                <a class="btn btn-primary btn-icon btn-circle btn-sm"
                                                                   href="{{ route('tips.delete', $tip->id) }}"
    ...
    <script>
        $(document).ready(function () {
            $(".zero-configuration").dataTable({
                "bStateSave": true,
                "fnStateSave": function (oSettings, oData) { localStorage.setItem('dataTable_tips', JSON.stringify(oData)); },
                "fnStateLoad": function (oSettings) { return JSON.parse(localStorage.getItem('dataTable_tips')); },
            });
        });
    </script>
@endsection

            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                    <div class="form-group breadcrum-right">
                        <div class="dropdown">
                            <a href="{{ route('tour_group.create') }}" class="btn btn-primary mb-2 waves-effect waves-light">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Tour Group</h4>
                                </div>
                                            ...
                                            <table class="table zero-configuration">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($groups as $group)
                                                        <tr>
                                                            <td>{{ $i }}</td>
                                                            <td>{{ $group->translate(app()->getLocale(), true)->name ?? '—' }}</td>
                                                            <td>
                                                            ...
                                                            <td class="text-right">
                                                                <a class="btn btn-primary btn-icon btn-circle btn-sm"
                                                                   href="{{ route('tour_group.edit', $group->id) }}" title="Edit">
                                                                    <i class="fas fa-edit"></i>
                                                                </a>
                                                                <a class="btn btn-primary btn-icon btn-circle btn-sm"
                                                                   href="{{ route('tour_group.delete', $group->id) }}"
    ...
    <script>
        $(document).ready(function () {
            $(".zero-configuration").dataTable({
                "bStateSave": true,
                "fnStateSave": function (oSettings, oData) { localStorage.setItem('dataTable_tour_groups', JSON.stringify(oData)); },
                "fnStateLoad": function (oSettings) { return JSON.parse(localStorage.getItem('dataTable_tour_groups')); },
            });
        });
    </script>
@endsection

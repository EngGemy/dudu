                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="card-content">
                                                                        <div class="card-body">
                                                                            ...
                                                                            <form class="form form-vertical" action="{{route('comments.store')}}" method="post" enctype="multipart/form-data">
                                                                                ...
                                                                                @foreach($comments as $comment)
                                                                                    <div class="card " style="padding:initial" >
                                                                                        <div class="card-header" id="quest{{$comment->id}}" style="margin-bottom: 20px;margin-left: 50px ">
                                                                                            ...
                                                                                            <a style="width:25px " class="btn btn-danger btn-icon btn-circle btn-sm" href="{{route('comments.delete', $comment->id)}}" onclick="return confirm('Are you sure you want to delete?');" title="Delete') ">
                                                                                                <i style="font-size: 11px"  class="fas fa-trash"></i>
                                                                                            </a>
                                                                                        </div>
                                                                                        <div id="quest_content{{$comment->id}}" class="collapse"  data-parent="#accordion-payment"  >
                                                                                            <div class="card-body">
                                                                                                <form class="form form-vertical" action="{{route('comments.update',$comment->id)}}" method="post" enctype="multipart/form-data">

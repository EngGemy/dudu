  ...
  <body>
    <div class="app">
      <header class="page-header">
        ...
        <div class="hero">
          <div class="container">
            <div class="hero_content">
              <h1 class="txt-shadow">
                All the travel inspiration ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â in one place
              </h1>
              <p class="txt-shadow">
        ...
        <img
          src="./assets/images/blogs-bg.jpeg"
      ...
      <main class="relative space-y-12 lg:space-y-16">
        <section class="pt-8">
          <div class="relative">
            <div class="sticky top-0 z-40 bg-white py-4">
              <div class="container">
                  <menu class="tabs mb-0">
                      ...
                      <li>
                          <a href="{{route('blogs-destination')}}" class="tab"  aria-current="page"
            ...
            <div class="container">
              <ol class="breadcrumb mb-12" aria-label="Breadcrumb">
                <li>
                  <a href="#"> Home </a>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <li aria-current="page">{{ __('front.site.sections.cairo') }}</li>
              </ol>
                  ...
                  >
                    ...
                    <div class="hs-accordion active accordion-filter">
                      ...
                      >
                        <svg class="accordion-icon size-4.5">
                          <use
                            href="./assets/images/icons/sprite.svg#travel-explore"
                          ></use>
                        </svg>
                        Top 3 Attraction Tours in Cairo
                      </button>
                      <div
                        class="hs-accordion-content accordion-content-wrapper"
                      >
                        <div
                          ...
                          data-lenis-prevent
                        >
                          <div class="flex gap-4.5 rounded-2xl p-4 shadow-xl">
                            <img
                            ...
                            <div>
                              ...
                              <p class="mb-2 text-sm text-gray">
                                Starting from
                                <span class="text-black">550$</span>
                              </p>
                          ...
                          <a
                            href="#"
                            class="mt-6 block text-center text-lg text-primary underline lg:text-xl"
                            >Browse All Cairo Tours</a
                          >
                        </div>
                      </div>
                    </div>

          ...
          <div class="relative">
            <div class="sticky top-0 z-40 mb-8 bg-white py-4">
              <div class="container">
                <menu class="tabs mb-0">
                  <li>
                    <a href="{{route('blogs')}}" class="tab" >{{ __('front.site.blog.essential_tour_tips') }}</a>
                  </li>
                  <li>
                    <a href="{{route('blogs-destination')}}" class="tab">{{ __('front.site.blog.explore_by_destination') }}</a>
                  </li>
                  <li>
                    <a href="{{route('blogs-interest')}}" class="tab">{{ __('front.site.blog.explore_by_interest') }}</a>
                  </li>
                  <li>
                    <a href="{{route('blogs-trending')}}" class="tab" aria-current="page">{{ __('front.site.blog.trending_now') }}</a>
                  </li>
                </menu>
              </div>
            </div>
            ...
            <div class="container">
              <ol class="breadcrumb mb-8" aria-label="Breadcrumb">
                ...
                <li aria-current="page">{{ __('front.site.blog.trending_now') }}</li>
              </ol>
        ...
        <div class="flex w-full flex-col overflow-hidden rounded-3xl bg-white">
          ...
          <div class="px-6 py-8 text-center">
            <img
              ...
              alt=""
            />
            <p class="text-2xl text-primary lg:text-3xl mb-3">{{ __('front.site.blog.your_email_received') }}</p>

          ...
          <div class="relative">
            <div class="sticky top-0 z-40 mb-8 bg-white py-4">
              <div class="container">
                <menu class="tabs mb-0">
                  <li>
                    <a href="{{route('blogs')}}" class="tab" >Essential Tour Tips</a>
                  </li>
                  <li>
                    <a href="{{route('blogs-destination')}}" class="tab">Explore By Destination</a>
                  </li>
                  <li>
                    <a href="{{route('blogs-interest')}}" class="tab">Explore By Interest</a>
                  </li>
                  <li>
                    <a href="{{route('blogs-trending')}}" class="tab" aria-current="page">Trending Now</a>
                  </li>
                </menu>
              </div>
            </div>
            ...
            <div class="container">
              <ol class="breadcrumb mb-8" aria-label="Breadcrumb">
                ...
                <li aria-current="page">Trending Now</li>
              </ol>

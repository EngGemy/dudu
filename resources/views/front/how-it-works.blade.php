...
<html lang="{{ app()->getLocale() }}" dir="{{ in_array(app()->getLocale(), ['ar','he']) ? 'rtl' : 'ltr' }}">
  <head>
    ...
    @include('front.layouts.hreflang')
      <meta itemprop="name" content="{{ $work_a?->meta_title }}">
      <meta itemprop="description" content="{{ $work_a?->meta_description }}">
      <meta itemprop="image" content="{{ $work_a?->meta_img }}">
        ...
        <div class="hero">
          <div class="container">
            <div class="hero_content">
              <h1 class="txt-shadow">LetÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s See How It Works Here!</h1>
              <p class="txt-shadow">
              ...
              <div class="mb-12 flex flex-col gap-7 lg:flex-row">
                <div class="w-full flex-1 max-lg:order-2">
                  <div class="mb-4 flex items-center gap-2">
                    <span
                      class="shrink-0 inline-flex size-8 items-center justify-center rounded-full bg-secondary text-white"
                      >1</span
                    >
                    <h2 class="text-xl font-semibold text-primary lg:text-2xl">
                      <span class="text-secondary"> </span>
                        {{ $work_a->title ?? 'Choose Your Destination'}}
                    </h2>
                  </div>

                  <p>
                    {!! $work_a->description  ?? 'Choose Your Destination'  !!}
                  </p>
                </div>

                <div class="w-full max-w-[510px] max-lg:order-1">
                  <img
                    src="{{$work_a->image_url ?? asset('assets/images/step-1.jpeg')}}"
        ...
        <section class="py-12 lg:py-16">
          <div class="container space-y-12">
            <div class="flex flex-col gap-7 lg:flex-row">
              <div class="w-full max-w-[510px] max-lg:order-1">
                <img
                  src="{{$work_b->image_url ?? asset('assets/images/step-2.jpeg')}}"
                  class="size-full max-h-[400px] rounded-3xl object-cover object-center"
                  alt=""
                />
              </div>
              <div class="w-full flex-1 max-lg:order-2">
                ...
                <p>
                    {!! $work_b->description ?? 'Choose Your Destination' !!}
                </p>
              </div>
            </div>
            ...
            <div class="flex flex-col gap-7 lg:flex-row">
              <div class="w-full flex-1 max-lg:order-2">
                ...
                <p>
                    {!! $work_c->description ?? 'Choose Your Destination' !!}
                </p>
              </div>

              <div class="w-full max-w-[510px] max-lg:order-1">
                <img
                  src="{{$work_c->image_url ?? asset('assets/images/step-3.jpeg')}}"
                  class="size-full max-h-[400px] rounded-3xl object-cover object-center"
                  alt=""
                />
              </div>
        ...
        <section class="py-12 lg:py-16">
          <div class="container space-y-12">
            <div class="flex flex-col gap-7 lg:flex-row">
              <div class="w-full max-w-[510px] max-lg:order-1">
                <img
                  src="{{ $work_d->image_url ??  asset('assets/images/step-4.jpeg')}}"
                  class="size-full max-h-[400px] rounded-3xl object-cover object-center"
                  alt=""
                />
              </div>
              <div class="w-full flex-1 max-lg:order-2">
                <div class="mb-4 flex items-center gap-2">
                  ...
                  >
                  <h2 class="text-xl font-semibold text-primary lg:text-2xl">
                    <span class="text-secondary"> </span> {{$work_d->title ?? 'title'}}
                  </h2>
                </div>

                <p>
                    {!! $work_d->description ?? 'Choose Your Destination' !!}
                </p>
              </div>
            </div>
          </div>
                ...
                @foreach($travel_services as $service)
                    <div>
                        <div>
                            ...
                            />
                            <h3 class="mb-4 text-2xl font-semibold text-secondary">
                                {{ $service->getStatus($service->status) ?? 'Accommodation'}}
                            </h3>
                        </div>
            ...
            <div class="flex flex-col gap-7 lg:flex-row">
              <div class="w-full flex-1 max-lg:order-2">
                <div class="mb-4 flex items-center gap-2">
                  ...
                  >
                  <h2 class="text-xl font-semibold text-primary lg:text-2xl">
                    <span class="text-secondary"> </span> {{$work_E->title ?? 'title'}}
                  </h2>
                </div>

                <p>
                    {!! $work_E->description ?? 'Choose Your Destination' !!}
                </p>
              </div>

              <div class="w-full max-w-[510px] max-lg:order-1">
                <img
                  src="{{$work_E->image_url ?? asset('assets/images/step-5.jpeg')}}"
                  class="size-full max-h-[400px] rounded-3xl object-cover object-center"
                  alt=""
                />
              </div>
        ...
        <section class="py-12 lg:py-16">
          <div class="container space-y-12">
            <div class="flex flex-col gap-7 lg:flex-row">
              <div class="w-full max-w-[510px] max-lg:order-1">
                <img
                  src="{{$work_F->image_url ?? asset('assets/images/step-6.jpeg')}}"
                  class="size-full max-h-[400px] rounded-3xl object-cover object-center"
                  alt=""
                />
              </div>
              <div class="w-full flex-1 max-lg:order-2">
                <div class="mb-4 flex items-center gap-2">
                  ...
                  >
                  <h2 class="text-xl font-semibold text-primary lg:text-2xl">
                    <span class="text-secondary"> </span> {{$work_F->title ?? 'title'}}
                  </h2>
                </div>

                <p>
                    {!! $work_F->description ?? 'Choose Your Destination' !!}
                </p>
              </div>
            </div>
            ...
            <div class="flex flex-col gap-7 lg:flex-row">
              <div class="w-full flex-1 max-lg:order-2">
                <div class="mb-4 flex items-center gap-2">
                  ...
                  >
                  <h2 class="text-xl font-semibold text-primary lg:text-2xl">
                    <span class="text-secondary"> </span> {{$work_G->title ?? 'title'}}
                  </h2>
                </div>

                <p>
                    {!! $work_G->description ?? 'Choose Your Destination' !!}
                </p>
              </div>

              <div class="w-full max-w-[510px] max-lg:order-1">
                <img
                  src="{{$work_G->image_url ?? asset('assets/images/step-7.jpeg')}}"
                  class="size-full max-h-[400px] rounded-3xl object-cover object-center"
                  alt=""
                />
              </div>

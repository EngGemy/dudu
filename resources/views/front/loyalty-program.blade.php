        ...
        <div class="hero justify-center p-0">
          <div class="container">
            <div class="hero_content">
              <h1 class="txt-shadow">{{ __('front.site.meta.loyalty_program') }}</h1>
            </div>
          </div>
        </div>

        <img
          src="./assets/images/loyalty-program.png"
          ...
          <div class="pt-8">
            <div class="container">
              <ol class="breadcrumb mb-8" aria-label="Breadcrumb">
                ...
                <li aria-current="page">{{ __('front.site.meta.loyalty_program') }}</li>
              </ol>

              <div class="mb-12">
                <h2 class="mb-6 text-xl font-semibold text-primary lg:text-2xl">
                  <span class="text-secondary">Loyalty </span> Program
                </h2>

                <div class="flex flex-col gap-8 lg:flex-row lg:gap-14">
                  <div
                    class="w-full flex-1 rounded-xl border border-primary p-12 text-center max-xl:order-2"
                  >
                    <p class="mb-4 text-lg text-primary lg:text-xl">
                      We Are Not Done Yet!... Have You Had A Tour With Us
                      Before?
                    </p>
                    <p class="mb-2 text-lg text-secondary lg:text-xl">
                      IF YES!
                    </p>
                    ...
                    <div class="flex flex-col gap-6 lg:flex-row">
                      ...
                      <div class="w-full lg:w-1/2">
                        <div
                          class="mx-auto mb-4 flex size-8 items-center justify-center rounded-full bg-secondary text-white"
                        >
                         {{ $special_offer->getStatus($special_offer->status) }}</td>
                        </div>
                        <div
                          class="mx-auto mb-4 flex size-35.5 items-center justify-center rounded-full border-2 border-primary/45"
                        >
                          <img
                            src="{{ $special_offer->image_url ?? "./assets/images/icons/discount.svg" }}"
                            class="size-24"
                            alt=""
                          />
                        </div>
                        <p
                          class="mb-1 text-lg font-semibold text-secondary lg:text-xl"
                        >
                        {{ $special_offer->title }}
                        </p>
                        <p class="lg:text-lg">
                      ...
                      {{-- <div class="w-full lg:w-1/2">
                        ...
                        <p class="lg:text-lg">
                          On paid tour once you get a friend/ relative to
                          confirm a tour with us and also he get 3% Discount
                        </p>
                      </div> --}}
                    </div>
                  </div>

                  <div class="w-full max-w-[385px] max-xl:order-1">
                    <img
              ...
              <p
                class="mx-auto mb-6 max-w-6xl text-balance text-center text-lg lg:text-xl"
              >
                Please let us know which option you will go for to send you the
                voucher accordingly
                <span class="text-secondary">A</span> or
                <span class="text-secondary">B</span>
                Once the condition to be applied is that the new tour must
                exceed 6 nights (for you or for the one from your side)
                <br />
                <span class="text-primary"
                  >The Offer is Valid Till The End of The Year!...Book Your Tour
                  Today And Start Your Adventure.!</span
                >
              </p>

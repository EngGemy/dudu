  ...
  <body>
    <div class="app">
      <nav id="headroom" class="navbar_nav primary hidden">
        <div class="container">
          <ul class="navbar_list">
            <li>
              <a href="./index.html" class="navbar_link" aria-current="page"
                >Home</a
              >
            </li>
            <li>
            ...
            <li>
              <a href="./blogs.html" class="navbar_link">{{ __('front.site.footer.blogs') }}</a>
            </li>
            <li>
              <a href="./about.html" class="navbar_link">About us</a>
            </li>
            <li>
              <a href="./loyalty-program.html" class="navbar_link"
                >{{ __('front.site.meta.loyalty_program') }}</a
              >
            </li>
            <li>
            ...
            <li>
              <a href="./how-it-works.html" class="navbar_link"
                >How it works?</a
              >
            </li>
            <li>
              <a href="./partner.html" class="navbar_link"
      ...
      <header class="page-header">
            ...
            <div class="navbar_top">
              ...
              <div class="flex items-center gap-4 lg:gap-10">
                ...
                <div class="flex items-center gap-2">
                  <svg class="size-5">
                    <use
                      href="./assets/images/icons/sprite.svg#cloud-sun"
                    ></use>
                  </svg>
                  <span class="text-sm">: 15 OC/ 60 OF</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <nav class="navbar_nav">
            <div class="container">
              <ul class="navbar_list">
                ...
                <li>
                  <a href="./egypt-tours.html" class="navbar_link"
                    >Egypt Tours</a
                  >
                </li>
                <li>
            ...
            <div class="flex rounded-xl border border-primary bg-primary">
              <div class="flex flex-1 divide-x divide-primary">
                <div class="shrink-0 rounded-bl-xl rounded-tl-xl bg-white">
                  ...
                  >
                    ...
                    >
                      ...
                      Accommodation
                      <svg
                        class="accordion-arrow ms-auto text-black hs-dropdown-open:rotate-180"
                ...
                <div class="flex shrink-0 items-center gap-3 bg-white px-4">
                  ...
                  />
                  <svg
                    class="accordion-arrow ms-auto shrink-0 text-black hs-dropdown-open:rotate-180"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
        ...
        <div class="hero">
          <div class="container">
            <div class="hero_content">
              ...
              <a
                href="#"
                onclick="lenis.scrollTo('#explore-tours', {offset: -60})"
                class="up-down absolute bottom-6 left-1/2 mx-auto -translate-x-1/2"
              >
                <svg class="size-6 text-white lg:size-8">
                  <use
                    href="./assets/images/icons/sprite.svg#arrow-double-down"
                  ></use>
                </svg>
              </a>
            </div>
        ...
        <section
          data-aos="fade"
          class="bg-primary py-12 text-white lg:bg-opacity-75 lg:py-16"
        >
          <div class="container">
      ...
      <section class="relative isolate">
        <div class="flex min-h-dvh flex-col">
          <img
            src="./assets/images/sub-hero-bg.jpeg"
            class="absolute inset-0 -z-10 h-dvh w-full object-cover object-center lg:h-full"
            alt=""
          />

          <header
            class="container flex flex-1 flex-col items-end justify-center"
          >
            <h2
              data-aos="fade-up"
              data-aos-delay="200"
              data-aos-duration="600"
              class="txt-shadow max-w-3xl text-3xl font-bold text-white lg:text-5xl lg:leading-normal"
            >
              Experience A Spectacular And A Memorable Egypt Guided Tour
            </h2>
          </header>
      ...
      <main class="space-y-12 pt-16 lg:space-y-16">
        <section id="explore-tours">
          <div class="container">
            <header data-aos="fade-up" class="section_header">
            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              ...
              >
                <a href="#" class="card">
                  <figure>
                    <img src="./assets/images/explore-1.jpeg" alt="" />
                  </figure>

                  <figcaption>
                    <h3>{{ __('front.site.sections.egypt_day_tour') }}</h3>
              ...
              >
                <a href="#" class="card">
                  <figure>
                    <img src="./assets/images/explore-2.jpeg" alt="" />
                  </figure>
              ...
              >
                <a href="#" class="card">
                  <figure>
                    <img src="./assets/images/explore-3.jpeg" alt="" />
                  </figure>
              ...
              >
                <a href="#" class="card">
                  <figure>
                    <img src="./assets/images/explore-4.jpeg" alt="" />
                  </figure>
                  ...
                  >
                    ...
                    <div class="tour-card__content">
                      <a href="./tour-details.html"
                        ><h3>{{ __('front.site.sections.cairo_luxor_tour') }}</h3></a
                      >
        ...
        <section id="egypt-tour-opp">
          <div class="container">
            ...
            >
              <h2 class="section_heading text-primary">
                <span>Explore</span> Egypt Tours Opportunities
              </h2>
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  ...
                  >
                    <a href="#" class="card">
                      <figure>
                        <img src="./assets/images/tour-opp-1.png" alt="" />
                      </figure>
                ...
                <div class="swiper-slide">
                  ...
                  >
                    <a href="#" class="card">
                      <figure>
                        <img src="./assets/images/tour-opp-2.png" alt="" />
                      </figure>
        ...
        <section id="egypt-tour-dest">
          <div class="container">
            ...
            >
              <h2 class="section_heading text-primary">
                <span>Explore</span> Top Egypt Destinations
              </h2>
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  ...
                  >
                    <a href="#" class="card">
                      <figure>
                        <img src="./assets/images/dest-1.jpeg" alt="" />
                      </figure>

                      <figcaption>
                        <h3>{{ __('front.site.sections.cairo') }}</h3>
                      </figcaption>
                    </a>
                  </div>
                </div>
                <div class="swiper-slide">
                  ...
                  >
                    <a href="#" class="card">
                      <figure>
                        <img src="./assets/images/dest-2.jpeg" alt="" />
                      </figure>
                ...
                <div class="swiper-slide">
                  ...
                  >
                    <a href="#" class="card">
                      <figure>
                        <img src="./assets/images/dest-3.jpeg" alt="" />
                      </figure>
                ...
                <div class="swiper-slide">
                  ...
                  >
                    <a href="#" class="card">
                      <figure>
                        <img src="./assets/images/dest-4.jpeg" alt="" />
                      </figure>
            ...
            <div class="swiper swiper-lg overflow-visible">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  ...
                  >
                    <a
                      href="./blog-preview.html"
                      class="tour-card__thumbnail-wrapper"
                    >
                      <img
                        src="./assets/images/tour-1.jpeg"
                        class="tour-card__thumbnail"
                    ...
                    <div class="tour-card__content">
                      <a href="./blog-preview.html"
                        ><h3>{{ __('front.site.sections.best_time_to_visit_egypt') }}</h3></a
                      >
                  ...
                  <div class="space-y-6">
                    ...
                    >
                      ...
                      <div class="flex items-center gap-3">
                        ...
                        >
                          <option value="NL">Ã°Å¸â€¡Â³Ã°Å¸â€¡Â±</option>
                          <option value="DE">Ã°Å¸â€¡Â©Ã°Å¸â€¡Âª</option>
                          <option value="FR">Ã°Å¸â€¡Â«Ã°Å¸â€¡Â·</option>
                          <option value="ES">Ã°Å¸â€¡ÂªÃ°Å¸â€¡Â¸</option>
                        </select>

...
<html lang="{{ app()->getLocale() }}" dir="{{ in_array(app()->getLocale(), ['ar','he']) ? 'rtl' : 'ltr' }}">
  <head>
    ...
    <title>{{ __('front.site.footer.become_partner') }}</title>

    @include('front.layouts.hreflang')
      <meta itemprop="name" content="{{ $partner_body?->meta_title ?? __('front.site.footer.become_partner') }}">
      <meta itemprop="description" content="{{ $partner_body?->meta_description ?? '' }}">
      <meta itemprop="image" content="{{ $partner_body?->meta_img ?? asset('assets/images/join-team.jpeg') }}">
        ...
        <div class="hero justify-center p-0">
          <div class="container">
            <div class="hero_content">
              <h1 class="txt-shadow">{{$slider->title ?? "Default Title"}}</h1>
            </div>
          </div>
        </div>

        <img
          src="{{$slider->image_url ?? './assets/images/partner-bg.png'}}"
      ...
      <main class="relative space-y-8 lg:space-y-10">
            ...
            <div class="container">
              ...
              <div class="mb-12 flex flex-col gap-7 lg:flex-row">
                <div class="w-full flex-1 max-lg:order-2">
                  ...
                  >
                    <span class="text-secondary"></span> {{$partner_header->title ?? "Default Titlesss"}}
                  </h2>

                  <p>
                    {!!  $partner_header->description ?? "Default Description" !!}
                  </p>
                </div>

                <div class="w-full max-w-[510px] max-lg:order-1">
                  <img
                    src="{{$partner_header->image_url ?? './assets/images/careers.jpeg'}}"
              ...
              <p class="mb-14 text-lg font-semibold text-primary lg:text-xl">
                Join as a partner and get more business from around the world.
                YouÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ll experience the benefits of becoming part of a trusted
                travel network, including access to our tried-and-true booking
                platform.
              </p>
            </div>
          </div>
        ...
        <section class="bg-primary py-12 text-white lg:py-16">
          <div class="container">
            ...
            <div
              class="grid gap-8 text-center md:grid-cols-2 lg:grid-cols-3 lg:gap-x-24 lg:gap-y-12"
            >
              <div>
                <div>
                  <img
        ...
        <section class="py-8 text-primary">
          <div class="container">
            <h2 class="mb-6 text-xl font-semibold lg:text-2xl">
              <span class="text-secondary"></span> {{$partner_body->title ?? "Default Title"}}
            </h2>
            <p class="mb-12 text-lg">
             {!!  $partner_body->description ?? "Default Description" !!}
            </p>

            <img
              src="{{$partner_body->image_url ?? './assets/images/join-team.jpeg'}}"
              class="max-h-[550px] w-full object-cover object-center"
              alt=""
            />
          </div>
        </section>

        <section class="bg-secondary pt-12 text-white lg:pt-16">
          <div class="container">
            <header class="section_header text-center">
              <h2 class="section_heading">{{ __('front.site.sections.what_is_doudou') }}</h2>
            </header>
            ...
            >
              <div>
                <div>
                  <img
                    src="./assets/images/icons/development-skill.svg"
                    class="mx-auto mb-2 size-12"
                    alt=""
                  />
                  <h3 class="txt-shadow mb-4 text-2xl font-semibold">
                    Real Experience
                  </h3>
                </div>

                <p class="line-clamp-3 leading-relaxed">
                  YouÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢re locals with passion for sharing your world. You care
                  about delivering positive, authentic travel experiences.
                </p>
              </div>
              <div>
                <div>
                  <img
                    src="./assets/images/icons/location-global.svg"
                    class="mx-auto mb-2 size-12"
                    alt=""
                  />
                  <h3 class="txt-shadow mb-4 text-2xl font-semibold">
                ...
                <p class="line-clamp-3 leading-relaxed">
                  Your itineraries are interesting and inspiring. You customize
                  carefully to meet the needs of each and every traveler.
                </p>
              </div>
              <div>
                <div>
                  <img
                    src="./assets/images/icons/best-seller.svg"
                    class="mx-auto mb-2 size-12"
                    alt=""
                  />
                  <h3 class="txt-shadow mb-4 text-2xl font-semibold">
                ...
                <p class="line-clamp-3 leading-relaxed">
                  You put your travelers first. YouÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢re responsive, reliable, and
                  take care of your customers, always.
                </p>
              </div>
            </div>
          </div>
        ...
        <section>
          <div class="container">
            <p class="mb-6">
              If the above applies to you, then you might be a fit for our
              travel partners program! Get access to our booking platform,
              hands-on sales and operations training, and a wider network of
              customers. Our system is easy and free to use. Are You Ready to Be
              A Member of Egypt Doudou Travel Agency?
            </p>

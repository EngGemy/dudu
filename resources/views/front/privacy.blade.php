        ...
        <div class="hero justify-center p-0">
          <div class="container">
            <div class="hero_content">
              <h1 class="txt-shadow">{{ __('front.site.footer.privacy_policy') }}</h1>
            </div>
          </div>
        </div>

        <img
          src="./assets/images/privacy-bg.jpeg"
          ...
          <div class="pt-8">
            <div class="container">
              <ol class="breadcrumb mb-8" aria-label="Breadcrumb">
                ...
                <li aria-current="page">{{ __('front.site.footer.privacy_policy') }}</li>
              </ol>
              ...
              <div class="mb-12">
                ...
                >
                  <span class="text-secondary">Privacy</span> Policy
                </h2>

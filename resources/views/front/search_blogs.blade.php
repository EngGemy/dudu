            ...
            <div class="container">
                ...
                >
                    <h2 class="section_heading text-primary">
                        <span>Results</span> Of Related Blogs
                    </h2>
                ...
                <div class="swiper swiper-lg overflow-visible">
                    <div class="swiper-wrapper">
                        ...
                        @empty
                            <div>
                                <li style="color: #0D6AAD; font-size: 20px" class="section_heading text-primary">
                                    Not Found Blogs For Related With Search by <span>{{$searchValue}}</span>
                                </li>
                            </div>

...
<div class="app">
    <nav id="headroom" class="navbar_nav primary hidden">
        ...
        <div class="hero">
            ...
            <img
                src="./assets/images/service-flight-reservation-bg.jpeg"
                class="hero__bg"
                alt=""
            />
        </div>
            ...
            <div class="relative pt-8">
                <div class="sticky top-0 z-40 mb-8 bg-white py-4">
                    <div class="container">
                        <menu class="tabs mb-0">
                            ...
                            <li>
                                <a href="{{route('services-flight-reservation')}}" class="tab" aria-current="page"
                ...
                <div class="container">
                    <ol class="breadcrumb mb-8" aria-label="Breadcrumb">
                        ...
                        <li aria-current="page">Flight Reservation</li>
                    </ol>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                >
                    <h2 class="section_heading text-primary">
                        <span>Explore</span> Articles About Flight Reservation in Egypt
                    </h2>
                        ...
                        @empty
                            ...
                            <div>
                                <li style="color: #0D6AAD; font-size: 20px">
                                    Not Found Blogs Related With Flight Service
                                </li>
                            </div>

  ...
  <body>
    <div class="app">
      <header class="page-header">
        ...
        <img
          src="./assets/images/service-tour-guidance-bg.jpeg"
          ...
          <div class="relative pt-8">
            <div class="sticky top-0 z-40 mb-8 bg-white py-4">
              <div class="container">
                  <menu class="tabs mb-0">
                      ...
                      <li>
                          <a href="{{route('services-tour-guidance')}}" class="tab" aria-current="page">Tour Guidance</a>
                      </li>
                  </menu>
              </div>
            </div>
            ...
            <div class="container">
              <ol class="breadcrumb mb-8" aria-label="Breadcrumb">
                ...
                <li aria-current="page">Tour Guidance</li>
              </ol>
            </div>
          </div>
        </section>
          ...
          <div class="container">
            ...
            >
              <h2 class="section_heading text-primary">
                <span>Explore</span> Articles About Tour Guidance in Egypt
              </h2>
            ...
            <div class="swiper swiper-lg overflow-visible">
              <div class="swiper-wrapper">
                  @forelse($guidance_blogs as $blog )
                  ...
                  @empty
                      ...
                      <div>
                          <li style="color: #0D6AAD; font-size: 20px">
                              ...
                              Not Found Blogs Related With Tour Guidance Service
                          </li>
                      </div>

  ...
  <body>
    <div class="app">
      <header class="page-header">
            ...
            >
                ...
                <div>
                  ...
                  <h3 class="mb-4 text-2xl font-semibold text-secondary">
                      {{ $service->getStatus($service->status) ?? 'Transportation' }}
                  </h3>
                </div>
        ...
        <img
          src="{{$travel_transportation->image_url ?? "./assets/images/service-transportation-bg.jpeg"}}"
      ...
      <main class="space-y-12 lg:space-y-16">
        <section>
          <div class="relative pt-8">
            <div class="sticky top-0 z-40 mb-8 bg-white py-4">
              <div class="container">
                  <menu class="tabs mb-0">
                      ...
                      <li>
                          <a href="{{route('services-transportation')}}" class="tab"  aria-current="page">Transportation</a>
                      </li>
                      <li>
                          <a href="{{route('services-flight-reservation')}}" class="tab">Flight Reservation</a>
                      </li>
                      <li>
                          <a href="{{route('services-visa-formalities')}}" class="tab">Visa Formalities</a>
                      </li>
                      <li>
            ...
            <div class="container">
              <div class="mb-6 flex flex-nowrap items-center gap-2 overflow-y-auto">
                <button type="button" aria-pressed="true"
                  class="rounded-lg border border-primary px-4 py-2 text-primary transition-colors hover:bg-opacity-75 aria-pressed:bg-primary aria-pressed:text-white lg:text-lg">Cairo
                  Transfer</button>
                <button type="button"
                  class="rounded-lg border border-primary px-4 py-2 text-primary transition-colors hover:bg-opacity-75 aria-pressed:bg-primary aria-pressed:text-white lg:text-lg">Hurghada
                  Transfer</button>
                <button type="button"
                  class="rounded-lg border border-primary px-4 py-2 text-primary transition-colors hover:bg-opacity-75 aria-pressed:bg-primary aria-pressed:text-white lg:text-lg">Luxor
                  Transfer</button>
                <button type="button"
                  class="rounded-lg border border-primary px-4 py-2 text-primary transition-colors hover:bg-opacity-75 aria-pressed:bg-primary aria-pressed:text-white lg:text-lg">Sharm
                  El-Sheik Transfer</button>
                <button type="button"
                  class="rounded-lg border border-primary px-4 py-2 text-primary transition-colors hover:bg-opacity-75 aria-pressed:bg-primary aria-pressed:text-white lg:text-lg">Marsa-Alam
                  Transfer</button>
              </div>
              ...
              <ol class="breadcrumb mb-8" aria-label="Breadcrumb">
                ...
                <li aria-current="page">Cairo Transfer</li>
              </ol>
              ...
              <div class="flex flex-col gap-7 lg:flex-row">
                <div class="w-full shrink-0 lg:max-w-[290px]">
                  ...
                  >
                    <svg class="size-5 text-white">
                      <use
                        href="./assets/images/icons/sprite.svg#settings"
                      ></use>
                    </svg>

                    Customize Your Transfer
                  </button>
                  ...
                  >
                    <div class="hs-accordion active accordion-filter">
                      ...
                      >
                        <svg class="accordion-icon">
                          <use
                            href="./assets/images/icons/sprite.svg#category"
                          ></use>
                        </svg>
                        Category
                        <svg
                          ...
                          <menu class="space-y-2">
                            <li>
                              <button
                                type="button"
                                aria-pressed="true"
                                class="font-normal text-black aria-pressed:font-semibold"
                              >
                              Cairo Transfer
                            </button>
                            </li>
                    ...
                    >
                      <svg class="accordion-icon">
                        <use
                          href="./assets/images/icons/sprite.svg#bus-card"
                        ></use>
                      </svg>
                      Transfer Type
                      <svg
                ...
                <div class="w-full lg:flex-1">
                  ...
                  >
                    <p class="text-xl font-semibold lg:text-2xl">
                      <span class="text-primary"
                        ><span class="text-secondary">{{ __('front.site.sections.cairo') }}</span> Transfer</span
                      >: {{$tours_transportation_count}} Available Tours
                    </p>
                  ...
                  >
                    <div class="hs-dropdown relative [--strategy:absolute]">
                      ...
                      <div
                        class="hs-dropdown-menu duration inset-x-0 top-0 z-10 mt-2 hidden min-w-52 space-y-3 rounded-lg bg-white p-5 opacity-0 shadow-md transition-[opacity,margin] before:absolute before:-top-4 before:start-0 before:h-4 before:w-full after:absolute after:-bottom-4 after:start-0 after:h-4 after:w-full hs-dropdown-open:opacity-100"
                      >
                        <button
                          type="button"
                          class="block font-normal text-black hover:text-primary aria-pressed:text-primary"
                    ...
                    <div class="hs-dropdown relative [--strategy:absolute]">
                      ...
                      >
                        <svg class="size-6 text-primary">
                          <use
                            href="./assets/images/icons/sprite.svg#bus-clock"
                          ></use>
                        </svg>
                  ...
                  <div class="space-y-6">
                   ...
                   <x-tour-transportation-component/>
                  ...
                  <nav class="pagination">
                    ...
                    <div class="pagination__numbers">
                      ...
                      <button type="button" class="pagination__number">
                        2
                      </button>
                      <button type="button" class="pagination__number">
                        3
          ...
          <div class="container">
            ...
            <div class="swiper swiper-lg overflow-visible">
              <div class="swiper-wrapper">
                  @forelse($transportation_blogs as $blog )
                  ...
                  @empty
                      ...
                      <div>
                          <li style="color: #0D6AAD; font-size: 20px">
                              Not Found Blogs Related With Transportation Service
                          </li>
                      </div>

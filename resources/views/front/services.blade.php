...
{{--              </div>--}}
        ...
        <img
          src="./assets/images/services-bg.jpeg"
      ...
      <main class="space-y-12 lg:space-y-16">
        <section>
          <div class="relative pt-8">
            ...
            <div class="container">
              <div
                class="mb-6 flex flex-nowrap items-center gap-2 overflow-y-auto"
              >
                <button
                  type="button"
                  aria-pressed="true"
                  class="rounded-lg border border-primary px-4 py-2 text-primary transition-colors hover:bg-opacity-75 aria-pressed:bg-primary aria-pressed:text-white lg:text-lg"
                >
                  High Luxury( 5- Stars)Tours
                </button>
                <button
                  type="button"
                  class="rounded-lg border border-primary px-4 py-2 text-primary transition-colors hover:bg-primary hover:text-white aria-pressed:bg-primary aria-pressed:text-white lg:text-lg"
                >
                  Standard 5* Tours
                </button>
                <button
              ...
              <ol class="breadcrumb mb-8" aria-label="Breadcrumb">
                ...
                <li aria-current="page">High Luxury (5-Stars) Tours</li>
              </ol>
              ...
              <div class="flex flex-col gap-7 lg:flex-row">
                ...
                <div class="w-full lg:flex-1">
                  ...
                  >
                    <p class="text-xl font-semibold lg:text-2xl">
                      <span class="text-primary"
                        ><span class="text-secondary">High</span> Luxury
                        (5-Stars) Tours</span
                      >: 44 Available Tours
                    </p>
                  ...
                  >
                    ...
                    <div
                      class="hs-dropdown relative flex [--strategy:absolute] [--auto-close:inside]"
                    >
                      <button
                        type="button"
                        class="hs-dropdown-toggle flex w-full items-center gap-3 text-nowrap rounded-xl border border-primary p-3 text-sm xl:px-4 xl:text-base"
                  ...
                  <!-- tours -->
                  <div class="space-y-6">
                    @foreach ($tours_Accommodation as $tour)
                    <article class="mega tour-card">
                      ...
                      <div class="tour-card__content">
                        <div class="tour-card__header">
                          <h3> {{$tour->overview_values('location_from')}}, {{$tour->overview_values('location_to')}} Tour</h3>
                    ...
                    {{-- <article class="mega tour-card">
                      ...
                      <div class="tour-card__content">
                        ...
                        <p class="tour-card__desc">
                          Combine the rich heritage of Cairo with a magical
                          5-day Nile cruise on this a magical 5-day Nile cruise
                          on this a magical 5-day Nile cruise ....
                        </p>

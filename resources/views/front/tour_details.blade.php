                                    ...
                                    >
                                        <div class="p-4 pt-0 lg:p-6 lg:pt-0">
                                            <p class="lg:text-lg lg:leading-relaxed">
                                                {!! $tour->translate(app()->getLocale(), true)->description ?? '' !!}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    >
                                        <div class="p-4 pt-0 lg:p-6 lg:pt-0">
                                            <div class="flex flex-col gap-6 lg:flex-row">
                                                @isset($tour->tour_highlights)
                                                @foreach($tour->tour_highlights as $highlight)
                                                <div class="w-full lg:w-3/5">
                                                    <p class="mb-4 text-lg font-medium text-primary">
                                                        {{$highlight->translate(app()->getLocale(), true)->name ?? ''}}
                                                    </p>
                                                    <ul class="space-y-1">
                                                        @php
                                                            $highlightValues = json_decode($highlight->translate(app()->getLocale(), true)->values ?? '[]') ?? [];
                                                        @endphp
                                    ...
                                    >
                                        <div class="p-4 pt-0 lg:p-6 lg:pt-0">
                                            <ul class="hs-accordion-group flex w-full flex-col">
                                                @if($tour->tour_iterations)
                                                    @foreach($tour->tour_iterations as $key=>$value)
                          ...
                          <span class="text-secondary">Packing</span> Tips
                                    ...
                                    >
                                        <div class="p-4 pt-0 lg:p-6 lg:pt-0">
                                            ...
                                            >
                                                @foreach($tour->tour_tips_values() as $name)
                                                <li
                        ...
                        <span>
                          <span class="text-secondary">Tour </span> Features
                                    ...
                                    >
                                        <div class="p-4 pt-0 lg:p-6 lg:pt-0">
                                            <ul class="space-y-2">
                                                @foreach($tour->tour_featues_values() as $name)
                                                <li class="flex items-center gap-2">
                                                    <svg class="size-5 shrink-0 text-primary">
                                                        <use
                                    ...
                                    >
                                        <div class="p-4 pt-0 lg:p-6 lg:pt-0">
                                            <div class="flex gap-2">
                                                ...
                                                {!! $tour->translate(app()->getLocale(), true)->tip_info ?? '' !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="mb-3 flex items-center gap-2">
                                            ...
                                            <div>
                                                <p class="mb-1 text-sm text-black">
                                                    ...
                                                    <span class="text-gray">{{ \Illuminate\Support\Carbon::parse($tour->date)->format('d F, Y')}}</span>
                                                </p>
                                                <div class="flex items-center gap-x-px">

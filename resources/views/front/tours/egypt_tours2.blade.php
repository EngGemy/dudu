    ...
    <div class="app">
      ...
      <header class="page-header">
        ...
        <div class="hero">
          ...
          <img src="./assets/images/tours-bg.jpeg" class="hero__bg" alt="" />
        </div>
        ...
        <img
          src="./assets/images/tours-bg.jpeg"
          ...
          <div class="sticky top-0 z-40 mb-8 bg-white py-4">
            <div class="container">
              <menu class="tabs mb-0">
                <li>
                  <a href="#" class="tab" aria-current="page">Travel Package</a>
                </li>
                <li>
                  <a href="#" class="tab">Egypt Day Tours</a>
                </li>
                <li>
                  <a href="#" class="tab">Nile River Cruises</a>
                </li>
                <li>
                  <a href="#" class="tab">{{ __('front.site.footer.egypt_shore_excursions') }}</a>
                </li>
              </menu>
            </div>
          </div>
          ...
          <header class="mb-6 lg:mb-10">
            <div class="container">
              ...
              >
                ...
                <button
                  type="button"
                  class="text-nowrap rounded-lg border border-primary px-4 py-2 text-primary transition-colors hover:bg-primary hover:text-white aria-pressed:bg-primary aria-pressed:text-white lg:text-lg"
                >
              ...
              <ol class="breadcrumb" aria-label="Breadcrumb">
                ...
                <li aria-current="page">Egypt Family Holiday</li>
              </ol>
            </div>
          </header>
                ...
                >
                  <p class="text-xl font-semibold lg:text-2xl">
                    <span class="text-primary"
                      ><span class="text-secondary">Egypt</span> Family
                      Holiday</span
                    >: 44 Available Tours
                  </p>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        class="hs-dropdown-menu duration inset-x-0 top-0 z-10 mt-2 hidden min-w-72 space-y-3 rounded-lg bg-white p-5 text-base opacity-0 shadow-md transition-[opacity,margin] before:absolute before:-top-4 before:start-0 before:h-4 before:w-full after:absolute after:-bottom-4 after:start-0 after:h-4 after:w-full hs-dropdown-open:opacity-100 lg:text-xs 2xl:text-sm"
                      >
                        <button
                          type="button"
                          class="block font-normal text-black hover:text-primary aria-pressed:text-primary"
                    ...
                    >
                      ...
                      <div
                        class="hs-dropdown-menu duration inset-x-0 top-0 z-10 mt-2 hidden space-y-3 rounded-lg bg-white p-5 text-base opacity-0 shadow-md transition-[opacity,margin] before:absolute before:-top-4 before:start-0 before:h-4 before:w-full after:absolute after:-bottom-4 after:start-0 after:h-4 after:w-full hs-dropdown-open:opacity-100 lg:text-xs 2xl:text-sm"
                      >
                        <button
                          type="button"
                          class="block font-normal text-black hover:text-primary aria-pressed:text-primary"
                  ...
                  <article class="mega tour-card">
                    ...
                    <div class="tour-card__content">
                      <div class="tour-card__header">
                        ...
                        <span class="tour-card__discount">-50%</span>
                      </div>
                      ...
                      <p class="tour-card__desc">
                        Combine the rich heritage of Cairo with a magical 5-day
                        Nile cruise on this a magical 5-day Nile cruise on this
                        a magical 5-day Nile cruise ....
                      </p>
    ...
    >
      ...
      >
        <div class="flex w-full flex-col overflow-hidden rounded-3xl bg-white">
          ...
          <img
            src="{{asset('assets/images/icons/model-decoration.pngs')}}"
            class="w-full"
            alt=""
          />
        </div>
